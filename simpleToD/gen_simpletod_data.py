...
root = "../data/todkg_dataset/runs/model1/"
tgt = "../data/SimpleTOD/processed/"

def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--data", default="test_retrieved.json", type=str, required=False, help="data file name")
